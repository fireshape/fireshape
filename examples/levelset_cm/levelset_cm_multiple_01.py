...
Q = fs.MultipleHelmholtzControlSpace(mesh_c, mesh_r, I, 25, 11, 0.1)
...
out = fd.File("alpha_scaling_01_higher_limit/moved.pvd")
out2 = fd.File("alpha_scaling_01_higher_limit/control.pvd")
