...
__all__ = ["GeneralDeformationRegularization", "DeformationRegularization",
           "CoarseDeformationRegularization"]


class GeneralDeformationRegularization(fs.DeformationObjective):

    def __init__(self, *args, form, **kwargs):
        super().__init__(*args, **kwargs)
        self.T = self.Q.intermediate_Ts
